...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𖤐↜𝑪𝑯 𝑺𝑶𝑼𝑹𝑪𝑬↝𖤐", url=f"https://t.me/kkk8lI")],
...
🎧 **بواسطه:** {ruser}
                ...
                try:
                    try:
                        ...
                        try:
                            ...
                            await dream.edit(f"◍ @s_e_t المساعد فشل فى الدخول الى الجروب بسبب:\n`{e}`\nفى حاله ظهور لك مثلا هذه الرساله تواصل مع المطور -> @s_e_t")
                    if invitelink.startswith("https://t.me/+"):
                        invitelink = invitelink.replace("https://t.me/+", "https://t.me/joinchat/")
                    await app2.join_chat(invitelink)
                except Exception as e:
        ...
        try:
            ...
            if 'CreateGroupCall' in str(e):
                ...
                return await dream.edit_text(f"{e}\n◍ في حاله ظهور لك مثل هذه المشكله تواصل مع المطور -> @s_e_t")
